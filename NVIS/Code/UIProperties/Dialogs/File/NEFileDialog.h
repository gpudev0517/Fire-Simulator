...
class NECEXP_NEUIPROPERTIES NEFileDialog : public QDialog
{
    Q_OBJECT
public:
    enum DialogMode { OPEN, SAVE, IMPORT, REFER, PLOT3D, COLORRAMP_OPEN, COLORRAMP_SAVE };

    NEFileDialog(QWidget *parent = nullptr, QString wDir = "", QString caption = "",  QString filter = "", DialogMode mode = OPEN, QFileDialog::FileMode flags = QFileDialog::ExistingFile);
    ~NEFileDialog();
