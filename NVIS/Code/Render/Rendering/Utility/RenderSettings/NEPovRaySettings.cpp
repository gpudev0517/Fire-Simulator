...
NEPovRaySettings::NEPovRaySettings()
{
	init();
}

NEPovRaySettings::NEPovRaySettings(NERenderSetting* common)
{
...
void NEPovRaySettings::initValidators()
{
...
*/
QString NEPovRaySettings::getRenderCommand(QString filePath)
{
...
QString NEPovRaySettings::getBatchRenderCommand(QString filePath)
{
	return getRenderCommand(filePath);
}

QString NEPovRaySettings::outputFileName(const int frameNr)
{
	QString fileName;
	QString frameNumber;
	frameNumber.sprintf("%06d", frameNr);
	fileName = frameNumber + ".pov";
...
QString NEPovRaySettings::includeFile(QString fileName)
{
...
QString NEPovRaySettings::getRenderOptions(QString filePath)
{
	QString options(" ");
...
QString NEPovRaySettings::threadCommand()
{
#if 0
...
QString NEPovRaySettings::imageSizeCommand(const NEImageSize *size)
{	
	return QString(" +W%1 +H%2").arg(size->width()).arg(size->height());
}

QString NEPovRaySettings::createStaticIncludes(QString path)
{	
...
void NEPovRaySettings::callPreset()
{
...
void NEPovRaySettings::callDefaultPreset()
{
	setMaxTraceLevel(16);
...
void NEPovRaySettings::callPMPreset()
{
	setPhotonMapping(true);
	setPhotonCount(100);
	setAutostop(0);
...
void NEPovRaySettings::callRadiosityPreset()
{
	setMaxTraceLevel(8);
