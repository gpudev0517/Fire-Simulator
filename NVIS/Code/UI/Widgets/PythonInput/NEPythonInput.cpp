    ...
    : QPlainTextEdit(parent)
{
    ...
    m_LineNumberArea = new NELineNumberArea<NEPythonInput>(this);
...
void NEPythonInput::init(QPlainTextEdit* outputWin)
{
...
void NEPythonInput::connectPythonStdOutErr()
{
...
void NEPythonInput::stdOut(const QString& s)
{
    m_StdOut += s;
    int idx;
...
void NEPythonInput::stdErr(const QString& s)
{
    m_HadError = true;
    m_StdErr += s;
    int idx;
...
void NEPythonInput::flushStdOut()
{
    if(!m_StdOut.isEmpty())
        stdOut("\n");
...
void NEPythonInput::executeCode(const QString& code)
{
    consoleMessage(">> " + code);
...
void NEPythonInput::setCurrentFont(const QColor& color, bool bold)
{
...
int NEPythonInput::commandPromptPosition()
{
...
void NEPythonInput::insertCompletion(const QString& completion)
{
...
//-----------------------------------------------------------------------------
void NEPythonInput::handleTabCompletion()
{
    QTextCursor textCursor   = this->textCursor();
...
void NEPythonInput::keyPressEvent(QKeyEvent* event)
{
...
void NEPythonInput::changeHistory()
{
...
void NEPythonInput::consoleMessage(const QString& message)
{
    outputWindow->moveCursor(QTextCursor::End);
    outputWindow->appendPlainText(QString());
    outputWindow->insertPlainText(message);
}
bool NEPythonInput::clearAfterExecute() const
{
    return m_ClearAfterExecute;
}

void NEPythonInput::setClearAfterExecute(bool val)
{
    m_ClearAfterExecute = val;
}


void NEPythonInput::lineNumberAreaPaintEvent(QPaintEvent* event)
{
...
int NEPythonInput::lineNumberAreaWidth()
{
    int digits = 1;
...
void NEPythonInput::resizeEvent(QResizeEvent* event)
{
...
void NEPythonInput::updateLineNumberAreaWidth(int newBlockCount)
{
    setViewportMargins(lineNumberAreaWidth(), 0, 0, 0);
}

void NEPythonInput::highlightCurrentLine()
{
...
void NEPythonInput::updateLineNumberArea(const QRect& rect, int dy)
{
    if(dy)
