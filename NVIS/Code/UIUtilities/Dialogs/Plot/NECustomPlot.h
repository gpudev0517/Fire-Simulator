/***************************************************************************
**                                                                        **
**  NECustomPlot, an easy to use, modern plotting widget for Qt            **
...
/*!
  The QCP Namespace contains general enums, QFlags and functions used throughout the NECustomPlot
  library.
...
/*!
  ...
  \see NECustomPlot::savePng, NECustomPlot::saveJpg, NECustomPlot::saveBmp, NECustomPlot::saveRastered
*/
...
/*!
  ...
  \see NECustomPlot::setAntialiasedElements, NECustomPlot::setNotAntialiasedElements
*/
...
/*!
  ...
  \see NECustomPlot::setPlottingHints
*/
enum PlottingHint { phNone              = 0x000 ///< <tt>0x000</tt> No hints are set
                    ...
                    ,phImmediateRefresh = 0x002 ///< <tt>0x002</tt> causes an immediate repaint() instead of a soft update() when NECustomPlot::replot() is called with parameter \ref NECustomPlot::rpRefreshHint.
...
/*!
  Defines the mouse interactions possible with NECustomPlot.
  
  \c Interactions is a flag of or-combined elements of this enum type.
  
  \see NECustomPlot::setInteractions
*/
enum Interaction { iNone              = 0x000 ///< <tt>0x000</tt> None of the interactions are possible
                   ...
                   ,iMultiSelect      = 0x004 ///< <tt>0x004</tt> The user can select multiple objects by holding the modifier set by \ref NECustomPlot::setMultiSelectModifier while clicking
...
/*!
  ...
  \see NECustomPlot::setSelectionRectMode, NECustomPlot::selectionRect, QCPSelectionRect
*/
...
class NEFEXP_NEUIUTILITIES QCPVector2D
{
public:
  QCPVector2D();
...
class NEFEXP_NEUIUTILITIES QCPPainter : public QPainter
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPAbstractPaintBuffer
{
public:
...
class NEFEXP_NEUIUTILITIES QCPPaintBufferPixmap : public QCPAbstractPaintBuffer
{
public:
...
#ifdef QCP_OPENGL_PBUFFER
class NEFEXP_NEUIUTILITIES QCPPaintBufferGlPbuffer : public QCPAbstractPaintBuffer
{
public:
...
#ifdef QCP_OPENGL_FBO
class NEFEXP_NEUIUTILITIES QCPPaintBufferGlFbo : public QCPAbstractPaintBuffer
{
public:
...
class NEFEXP_NEUIUTILITIES QCPLayer : public QObject
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(NECustomPlot* parentPlot READ parentPlot)
...
public:
  ...
  */
  ...
  QCPLayer(NECustomPlot* parentPlot, const QString &layerName);
  virtual ~QCPLayer();
  
  // getters:
  NECustomPlot *parentPlot() const { return mParentPlot; }
...
private:
  ...
  friend class NECustomPlot;
  friend class QCPLayerable;
};
Q_DECLARE_METATYPE(QCPLayer::LayerMode)

class NEFEXP_NEUIUTILITIES QCPLayerable : public QObject
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(bool visible READ visible WRITE setVisible)
  ...
  /// \endcond
public:
  QCPLayerable(NECustomPlot *plot, QString targetLayer=QString(), QCPLayerable *parentLayerable=nullptr);
...
protected:
  ...
  // introduced virtual methods:
  virtual void parentPlotInitialized(NECustomPlot *parentPlot);
  ...
  // non-property methods:
  void initializeParentPlot(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPRange
{
public:
  double lower, upper;
...
class NEFEXP_NEUIUTILITIES QCPDataRange
{
public:
  QCPDataRange();
...
class NEFEXP_NEUIUTILITIES QCPDataSelection
{
public:
...
class NEFEXP_NEUIUTILITIES QCPSelectionRect : public QCPLayerable
{
  Q_OBJECT
public:
  explicit QCPSelectionRect(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPMarginGroup : public QObject
{
  Q_OBJECT
public:
  explicit QCPMarginGroup(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPLayoutElement : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
public:
  ...
  */
  ...
  explicit QCPLayoutElement(NECustomPlot *parentPlot=nullptr);
...
protected:
  ...
  virtual void parentPlotInitialized(NECustomPlot *parentPlot) Q_DECL_OVERRIDE;
...
class NEFEXP_NEUIUTILITIES QCPLayout : public QCPLayoutElement
{
  Q_OBJECT
public:
  explicit QCPLayout();
...
class NEFEXP_NEUIUTILITIES QCPLayoutGrid : public QCPLayout
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPLayoutInset : public QCPLayout
{
  Q_OBJECT
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPLineEnding
{
  Q_GADGET
public:
  /*!
...
public:
  ...
  */
  ...
  explicit QCPLabelPainterPrivate(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPAxisTicker
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerDateTime : public QCPAxisTicker
{
public:
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerTime : public QCPAxisTicker
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerFixed : public QCPAxisTicker
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerText : public QCPAxisTicker
{
public:
  QCPAxisTickerText();
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerPi : public QCPAxisTicker
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPAxisTickerLog : public QCPAxisTicker
{
public:
  QCPAxisTickerLog();
...
class NEFEXP_NEUIUTILITIES QCPGrid :public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPAxis : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
{
public:
  explicit QCPAxisPainterPrivate(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPScatterStyle
{
  Q_GADGET
public:
  /*!
...
template <class DataType>
class QCPDataContainer // no NEFEXP_NEUIUTILITIES, template class ends up in header (cpp included below)
{
public:
...
class NEFEXP_NEUIUTILITIES QCPSelectionDecorator
{
  Q_GADGET
public:
...
class NEFEXP_NEUIUTILITIES QCPAbstractPlottable : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPItemAnchor
{
  Q_GADGET
public:
  QCPItemAnchor(NECustomPlot *parentPlot, QCPAbstractItem *parentItem, const QString &name, int anchorId=-1);
...
class NEFEXP_NEUIUTILITIES QCPItemPosition : public QCPItemAnchor
{
  Q_GADGET
public:
  /*!
  ...
  */
  ...
  QCPItemPosition(NECustomPlot *parentPlot, QCPAbstractItem *parentItem, const QString &name);
...
class NEFEXP_NEUIUTILITIES QCPAbstractItem : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
  explicit QCPAbstractItem(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES NECustomPlot : public QWidget
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
public:
  ...
  */
  ...
  /*!
    Defines with what timing the NECustomPlot surface is refreshed after a replot.
  ...
  */
  ...
  explicit NECustomPlot(QWidget *parent = nullptr);
  virtual ~NECustomPlot() Q_DECL_OVERRIDE;
  ...
  Q_SLOT void replot(NECustomPlot::RefreshPriority refreshPriority=NECustomPlot::rpRefreshHint);
...
Q_DECLARE_METATYPE(NECustomPlot::LayerInsertMode)
Q_DECLARE_METATYPE(NECustomPlot::RefreshPriority)
...
*/
template<class PlottableType>
PlottableType *NECustomPlot::plottableAt(const QPointF &pos, bool onlySelectable, int *dataIndex) const
{
...
*/
template<class ItemType>
ItemType *NECustomPlot::itemAt(const QPointF &pos, bool onlySelectable) const
{
...
template <class DataType>
class QCPAbstractPlottable1D : public QCPAbstractPlottable, public QCPPlottableInterface1D // no NEFEXP_NEUIUTILITIES, template class ends up in header (cpp included below)
{
...
/*!
  ...
  lineData. NaN points create gaps in the line, as expected from NECustomPlot's plottables (this is
  ...
  QPainter::drawPolyline if the configured \ref NECustomPlot::setPlottingHints() and \a painter
  style allows.
*/
template <class DataType>
...
class NEFEXP_NEUIUTILITIES QCPColorGradient
{
  Q_GADGET
public:
  /*!
...
class NEFEXP_NEUIUTILITIES QCPSelectionDecoratorBracket : public QCPSelectionDecorator
{
  Q_GADGET
public:
...
class NEFEXP_NEUIUTILITIES QCPAxisRect : public QCPLayoutElement
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPixmap background READ background WRITE setBackground)
  ...
  /// \endcond
public:
  explicit QCPAxisRect(NECustomPlot *parentPlot, bool setupDefaultAxes=true);
...
class NEFEXP_NEUIUTILITIES QCPAbstractLegendItem : public QCPLayoutElement
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPPlottableLegendItem : public QCPAbstractLegendItem
{
  Q_OBJECT
public:
...
class NEFEXP_NEUIUTILITIES QCPLegend : public QCPLayoutGrid
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPTextElement : public QCPLayoutElement
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
  explicit QCPTextElement(NECustomPlot *parentPlot);
  QCPTextElement(NECustomPlot *parentPlot, const QString &text);
  QCPTextElement(NECustomPlot *parentPlot, const QString &text, double pointSize);
  QCPTextElement(NECustomPlot *parentPlot, const QString &text, const QString &fontFamily, double pointSize);
  QCPTextElement(NECustomPlot *parentPlot, const QString &text, const QFont &font);
...
class NEFEXP_NEUIUTILITIES QCPColorScale : public QCPLayoutElement
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
  explicit QCPColorScale(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPGraphData
{
public:
  QCPGraphData();
...
class NEFEXP_NEUIUTILITIES QCPGraph : public QCPAbstractPlottable1D<QCPGraphData>
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPCurveData
{
public:
  QCPCurveData();
...
class NEFEXP_NEUIUTILITIES QCPCurve : public QCPAbstractPlottable1D<QCPCurveData>
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QCPScatterStyle scatterStyle READ scatterStyle WRITE setScatterStyle)
...
class NEFEXP_NEUIUTILITIES QCPBarsGroup : public QObject
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
public:
  ...
  */
  ...
  explicit QCPBarsGroup(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPBarsData
{
public:
  QCPBarsData();
...
class NEFEXP_NEUIUTILITIES QCPBars : public QCPAbstractPlottable1D<QCPBarsData>
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPStatisticalBoxData
{
public:
...
class NEFEXP_NEUIUTILITIES QCPStatisticalBox : public QCPAbstractPlottable1D<QCPStatisticalBoxData>
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(double width READ width WRITE setWidth)
...
class NEFEXP_NEUIUTILITIES QCPColorMapData
{
public:
...
class NEFEXP_NEUIUTILITIES QCPColorMap : public QCPAbstractPlottable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QCPRange dataRange READ dataRange WRITE setDataRange NOTIFY dataRangeChanged)
...
class NEFEXP_NEUIUTILITIES QCPFinancialData
{
public:
  QCPFinancialData();
...
class NEFEXP_NEUIUTILITIES QCPFinancial : public QCPAbstractPlottable1D<QCPFinancialData>
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPErrorBarsData
{
public:
  QCPErrorBarsData();
...
class NEFEXP_NEUIUTILITIES QCPErrorBars : public QCPAbstractPlottable, public QCPPlottableInterface1D
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPItemStraightLine : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  explicit QCPItemStraightLine(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemLine : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  explicit QCPItemLine(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemCurve : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  explicit QCPItemCurve(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemRect : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  explicit QCPItemRect(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemText : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
  explicit QCPItemText(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemEllipse : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
  ...
  /// \endcond
public:
  explicit QCPItemEllipse(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemPixmap : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  ...
  /// \endcond
public:
  explicit QCPItemPixmap(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemTracer : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
...
public:
  ...
  */
  ...
  explicit QCPItemTracer(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPItemBracket : public QCPAbstractItem
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
  Q_PROPERTY(QPen pen READ pen WRITE setPen)
...
public:
  ...
  */
  ...
  explicit QCPItemBracket(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPPolarAxisRadial : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPPolarAxisAngular : public QCPLayoutElement
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
public:
  ...
  */
  ...
  explicit QCPPolarAxisAngular(NECustomPlot *parentPlot);
...
class NEFEXP_NEUIUTILITIES QCPPolarGrid :public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
...
class NEFEXP_NEUIUTILITIES QCPPolarLegendItem : public QCPAbstractLegendItem
{
  Q_OBJECT
public:
...
class NEFEXP_NEUIUTILITIES QCPPolarGraph : public QCPLayerable
{
  Q_OBJECT
  /// \cond INCLUDE_QPROPERTIES
