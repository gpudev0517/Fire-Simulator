...
void PythonQt::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PythonQt::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQt::pythonStdOut)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PythonQt::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQt::pythonStdErr)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PythonQt::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQt::pythonHelpRequest)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (PythonQt::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PythonQt::systemExitExceptionRaised)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PythonQt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PythonQt.data,
      qt_meta_data_PythonQt,  qt_static_metacall, nullptr, nullptr}
};
...
QT_INIT_METAOBJECT const QMetaObject PythonQtPrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PythonQtPrivate.data,
      qt_meta_data_PythonQtPrivate,  qt_static_metacall, nullptr, nullptr}
};
