...
static char* g_RectTexture_PS_GLSL =
    (char*) STRINGIFY(
        ...
        void main()
        {
            FragColor = texture2D( g_t0, VtxGeoOutput1.xy );
        }
     );

//--------------------------------------------------------------------------------
void GLSLPrograms::Default_PS::Create(const GFSDK_SSAO_GLFunctions& GL, const char *FragmentShaderSource)
{
    GLSLProgram::Create(GL, g_FullscreenTriangle_VS_GLSL, FragmentShaderSource);

    m_Texture = GetUniformLocation(GL, "g_t0");
    ASSERT(m_Texture != -1);
}

void GLSLPrograms::Default_PS::Create(const GFSDK_SSAO_GLFunctions& GL)
{
    Create(GL, g_RectTexture_PS_GLSL);
}
...
#include "shaders/CopyDepth_PS.cpp"
#include "shaders/LinearizeDepth_PS.cpp"
#include "shaders/DeinterleaveDepth_PS.cpp"
#include "shaders/DebugNormals_PS.cpp"
#include "shaders/ReconstructNormal_PS.cpp"
#include "shaders/ReinterleaveAO_PS.cpp"
#include "shaders/BlurX_PS.cpp"
#include "shaders/BlurY_PS.cpp"
#include "shaders/CoarseAO_PS.cpp"
