...
{
//--------------------------------------------------------------------------
class Default_PS : public GFSDK::SSAO::GL::GLSLProgram
{
public:
    Default_PS()
        : m_Texture(-1)
    ...
    void SetTexture(const GFSDK_SSAO_GLFunctions& GL, const GFSDK_SSAO_Texture_GL &Texture)
    {
        GLSLProgram::SetTexture(GL, Texture.Target, m_Texture, Texture.TextureId, 0);
    }
...
#include "shaders/CopyDepth_PS.h"
#include "shaders/LinearizeDepth_PS.h"
#include "shaders/DeinterleaveDepth_PS.h"
#include "shaders/DebugNormals_PS.h"
#include "shaders/ReconstructNormal_PS.h"
#include "shaders/ReinterleaveAO_PS.h"
#include "shaders/BlurX_PS.h"
#include "shaders/BlurY_PS.h"
#include "shaders/CoarseAO_PS.h"
...
struct Shaders
{
    ...
    GLSLPrograms::Default_PS Default_PS;
