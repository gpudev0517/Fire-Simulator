...
{
    QOpenGLContext::currentContext()->functions()->glAttachShader(program, shader);
}
inline void BindBuffer(GLenum target, GLuint buffer)
{
    QOpenGLContext::currentContext()->functions()->glBindBuffer(target, buffer);
}
inline void BindBufferBase(GLenum target, GLuint index, GLuint buffer)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glBindBufferBase(target, index, buffer);
}
inline void BindFramebuffer(GLenum target, GLuint framebuffer)
{
    QOpenGLContext::currentContext()->functions()->glBindFramebuffer(target, framebuffer);
}
inline void BindFragDataLocation(GLuint a, GLuint b, const GLchar* c)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glBindFragDataLocation(a, b, c);
}
inline void BindTexture(GLenum target, GLuint texture)
{
    QOpenGLContext::currentContext()->functions()->glBindTexture(target, texture);
}
inline void BindVertexArray(GLuint array)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glBindVertexArray(array);
}
inline void BlendColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha)
{
    QOpenGLContext::currentContext()->functions()->glBlendColor(red, green, blue, alpha);
}
inline void BlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha)
{
    QOpenGLContext::currentContext()->functions()->glBlendEquationSeparate(modeRGB, modeAlpha);
}
inline void BlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha)
{
    QOpenGLContext::currentContext()->functions()->glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha, dfactorAlpha);
}
inline void BufferData(GLenum target, GLsizeiptr size, const GLvoid* data, GLenum usage)
{
    QOpenGLContext::currentContext()->functions()->glBufferData(target, size, data, usage);
}
inline void BufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data)
{
    QOpenGLContext::currentContext()->functions()->glBufferSubData(target, offset, size, data);
}
inline void ColorMaski(GLuint a, GLboolean b, GLboolean c, GLboolean d, GLboolean e)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glColorMaski(a, b, c, d, e);
}
inline void CompileShader(GLuint shader)
{
    QOpenGLContext::currentContext()->functions()->glCompileShader(shader);
}
inline GLuint CreateShader(GLenum type)
{
    return QOpenGLContext::currentContext()->functions()->glCreateShader(type);
}
inline GLuint CreateProgram(void)
{
    return QOpenGLContext::currentContext()->functions()->glCreateProgram();
}
inline void DeleteBuffers(GLsizei n, const GLuint* buffers)
{
    QOpenGLContext::currentContext()->functions()->glDeleteBuffers(n, buffers);
}
inline void DeleteFramebuffers(GLsizei n, const GLuint* framebuffers)
{
    QOpenGLContext::currentContext()->functions()->glDeleteFramebuffers(n, framebuffers);
}
inline void DeleteProgram(GLuint program)
{
    QOpenGLContext::currentContext()->functions()->glDeleteProgram(program);
}
inline void DeleteShader(GLuint shader)
{
    QOpenGLContext::currentContext()->functions()->glDeleteShader(shader);
}
inline void DeleteTextures(GLsizei n, const GLuint *textures)
{
    QOpenGLContext::currentContext()->functions()->glDeleteTextures(n, textures);
}
inline void DeleteVertexArrays(GLsizei n, const GLuint* arrays)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glDeleteVertexArrays(n, arrays);
}
inline void Disable(GLenum cap)
{
    QOpenGLContext::currentContext()->functions()->glDisable(cap);
}
inline void DrawBuffers(GLsizei n, const GLenum* bufs)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glDrawBuffers(n, bufs);
}
inline void Enable(GLenum cap)
{
    QOpenGLContext::currentContext()->functions()->glEnable(cap);
}
inline void DrawArrays(GLenum mode, GLint first, GLsizei count)
{
    QOpenGLContext::currentContext()->functions()->glDrawArrays(mode, first, count);
}
inline void FramebufferTexture(GLenum a, GLenum b, GLuint c, GLint d)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glFramebufferTexture(a, b, c, d);
}
inline void FramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
    QOpenGLContext::currentContext()->functions()->glFramebufferTexture2D(target, attachment, textarget, texture, level);
}
inline void FramebufferTextureLayer(GLenum target,GLenum attachment, GLuint texture,GLint level,GLint layer)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glFramebufferTextureLayer(target, attachment, texture, level, layer);
}
inline void GenBuffers(GLsizei n, GLuint* buffers)
{
    QOpenGLContext::currentContext()->functions()->glGenBuffers(n, buffers);
}
inline void GenFramebuffers(GLsizei n, GLuint* framebuffers)
{
    QOpenGLContext::currentContext()->functions()->glGenFramebuffers(n, framebuffers);
}
inline void GenTextures(GLsizei n, GLuint *textures)
{
    QOpenGLContext::currentContext()->functions()->glGenTextures(n, textures);
}
inline void GenVertexArrays(GLsizei n, GLuint* arrays)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glGenVertexArrays(n, arrays);
}
inline GLenum GetError(void)
{
    return QOpenGLContext::currentContext()->functions()->glGetError();
}
inline void GetBooleani_v(GLenum a, GLuint b, GLboolean* c)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glGetBooleani_v(a, b, c);
}
inline void GetFloatv(GLenum pname, GLfloat *params)
{
    QOpenGLContext::currentContext()->functions()->glGetFloatv(pname, params);
}
inline void GetIntegerv(GLenum pname, GLint *params)
{
    QOpenGLContext::currentContext()->functions()->glGetIntegerv(pname, params);
}
inline void GetIntegeri_v(GLenum target, GLuint index, GLint* data)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glGetIntegeri_v(target, index, data);
}
inline void GetProgramiv(GLuint program, GLenum pname, GLint* param)
{
    QOpenGLContext::currentContext()->functions()->glGetProgramiv(program, pname, param);
}
inline void GetProgramInfoLog(GLuint program, GLsizei bufSize, GLsizei* length, GLchar* infoLog)
{
    QOpenGLContext::currentContext()->functions()->glGetProgramInfoLog(program, bufSize, length, infoLog);
}
inline void GetShaderiv(GLuint shader, GLenum pname, GLint* param)
{
    QOpenGLContext::currentContext()->functions()->glGetShaderiv(shader, pname, param);
}
inline void GetShaderInfoLog(GLuint shader, GLsizei bufSize, GLsizei* length, GLchar* infoLog)
{
    QOpenGLContext::currentContext()->functions()->glGetShaderInfoLog(shader, bufSize, length, infoLog);
}
inline const GLubyte* GetString(GLenum name)
{
    return QOpenGLContext::currentContext()->functions()->glGetString(name);
}
inline GLuint GetUniformBlockIndex(GLuint program, const GLchar* uniformBlockName)
{
    return QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glGetUniformBlockIndex(program, uniformBlockName);
}
inline GLint GetUniformLocation(GLuint program, const GLchar* name)
{
    return QOpenGLContext::currentContext()->functions()->glGetUniformLocation(program, name);
}
inline void GetTexLevelParameteriv(GLenum target, GLint level, GLenum pname, GLint *params)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glGetTexLevelParameteriv(target, level, pname, params);
}
inline GLboolean IsEnabled(GLenum cap)
{
    return QOpenGLContext::currentContext()->functions()->glIsEnabled(cap);
}
inline GLboolean IsEnabledi(GLenum a, GLuint b)
{
    return QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glIsEnabledi(a, b);
}
inline void LinkProgram(GLuint program)
{
    QOpenGLContext::currentContext()->functions()->glLinkProgram(program);
}
inline void PolygonOffset(GLfloat factor, GLfloat units)
{
    QOpenGLContext::currentContext()->functions()->glPolygonOffset(factor, units);
}
inline void ShaderSource(GLuint shader, GLsizei count, const GLchar* const* strings, const GLint* lengths)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glShaderSource(shader, count, strings, lengths);
}
...
{
    QOpenGLContext::currentContext()->functions()->glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels);
}
...
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glTexImage3D(target, level, internalFormat, width, height, depth, border, format, type, pixels);
}
inline void TexParameteri(GLenum target, GLenum pname, GLint param)
{
    QOpenGLContext::currentContext()->functions()->glTexParameteri(target, pname, param);
}
inline void TexParameterfv(GLenum target, GLenum pname, const GLfloat *params)
{
    QOpenGLContext::currentContext()->functions()->glTexParameterfv(target, pname, params);
}
inline void Uniform1i(GLint location, GLint v0)
{
    QOpenGLContext::currentContext()->functions()->glUniform1i(location, v0);
}
inline void UniformBlockBinding(GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding)
{
    QOpenGLContext::currentContext()->versionFunctions<QOpenGLFunctions_4_3_Compatibility>()->glUniformBlockBinding(program, uniformBlockIndex, uniformBlockBinding);
}
inline void UseProgram(GLuint program)
{
    QOpenGLContext::currentContext()->functions()->glUseProgram(program);
}
inline void Viewport(GLint x, GLint y, GLsizei width, GLsizei height)
{
    QOpenGLContext::currentContext()->functions()->glViewport(x, y, width, height);
}
...
{\
    ...
    GL.glAttachShader = AttachShader;\
    GL.glBindBuffer = BindBuffer;\
    GL.glBindBufferBase = BindBufferBase;\
    GL.glBindFramebuffer = BindFramebuffer;\
    GL.glBindFragDataLocation = BindFragDataLocation;\
    GL.glBindTexture = BindTexture;\
    GL.glBindVertexArray = BindVertexArray;\
    GL.glBlendColor = BlendColor;\
    GL.glBlendEquationSeparate = BlendEquationSeparate;\
    GL.glBlendFuncSeparate = BlendFuncSeparate;\
    GL.glBufferData = BufferData;\
    GL.glBufferSubData = BufferSubData;\
    GL.glColorMaski = ColorMaski;\
    GL.glCompileShader = CompileShader;\
    GL.glCreateShader = CreateShader;\
    GL.glCreateProgram = CreateProgram;\
    GL.glDeleteBuffers = DeleteBuffers;\
    GL.glDeleteFramebuffers = DeleteFramebuffers;\
    GL.glDeleteProgram = DeleteProgram;\
    GL.glDeleteShader = DeleteShader;\
    GL.glDeleteTextures = DeleteTextures;\
    GL.glDeleteVertexArrays = DeleteVertexArrays;\
    GL.glDisable = Disable;\
    GL.glDrawBuffers = DrawBuffers;\
    GL.glEnable = Enable;\
    GL.glDrawArrays = DrawArrays;\
    GL.glFramebufferTexture = FramebufferTexture;\
    GL.glFramebufferTexture2D = FramebufferTexture2D;\
    GL.glFramebufferTextureLayer = FramebufferTextureLayer;\
    GL.glGenBuffers = GenBuffers;\
    GL.glGenFramebuffers = GenFramebuffers;\
    GL.glGenTextures = GenTextures;\
    GL.glGenVertexArrays = GenVertexArrays;\
    GL.glGetError = GetError;\
    GL.glGetBooleani_v = GetBooleani_v;\
    GL.glGetFloatv = GetFloatv;\
    GL.glGetIntegerv = GetIntegerv;\
    GL.glGetIntegeri_v = GetIntegeri_v;\
    GL.glGetProgramiv = GetProgramiv;\
    GL.glGetProgramInfoLog = GetProgramInfoLog;\
    GL.glGetShaderiv = GetShaderiv;\
    GL.glGetShaderInfoLog = GetShaderInfoLog;\
    GL.glGetString = GetString;\
    GL.glGetUniformBlockIndex = GetUniformBlockIndex;\
    GL.glGetUniformLocation = GetUniformLocation;\
    GL.glGetTexLevelParameteriv = GetTexLevelParameteriv;\
    GL.glIsEnabled = IsEnabled;\
    GL.glIsEnabledi = IsEnabledi;\
    GL.glLinkProgram = LinkProgram;\
    GL.glPolygonOffset = PolygonOffset;\
    GL.glShaderSource = (GFSDK_SSAO_GLFunctions::glShaderSourceGLESType)ShaderSource;\
    GL.glTexImage2D = TexImage2D;\
    GL.glTexImage3D = TexImage3D;\
    GL.glTexParameteri = TexParameteri;\
    GL.glTexParameterfv = TexParameterfv;\
    GL.glUniform1i = Uniform1i;\
    GL.glUniformBlockBinding = UniformBlockBinding;\
