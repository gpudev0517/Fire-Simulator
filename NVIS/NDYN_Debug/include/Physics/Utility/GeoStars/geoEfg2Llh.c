...
void     geoEfg2Llh (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    ...
    *lat = atan((efg[GEO_G] + ee2 * b * GeoStar_cube(su) ) /
    ( p - e2 * a * GeoStar_cube(cu) ) );
...
void     geoEfg2Llh_hm (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
...
void     geoEfg2Llh_torge (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double  a, flat, b, e2, ee2;
...
*/
void     geoEfg2Llh_bowring (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double  a, flat, b, e2, ee2;
    ...
    *lon = atan2(efg[GEO_F],efg[GEO_E]);  // atan(f/e)
    ...
    for(i=0;i<GEO_EFG2LLH_MAX_ITS;i++)
    {
        ...
        slat = sin(b1);
        clat = cos(b1);
        *lat = atan((efg[GEO_G]+ ee2b * GeoStar_cube(slat) ) /
        (p - ae2 * GeoStar_cube(clat) ) );
        b0 = atan((boa) * tan(*lat));
...
*/
void     geoEfg2Llh_aa (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
...
*/
void     geoEfg2Llh_borkowski (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double a, flat, b, e2, ee2;
...
*/
void     geoEfg2Llh_vermeille (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double a, flat, b, e2, ee2;
...
*/
void     geoEfg2Llh_heikkinen (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double a, flat, b, e2, ee2;
...
void     geoEfg2Llh_toms (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double a, flat, b, e2, ee2;
    ...
    t1= efg[GEO_G] + b * ee2 * GeoStar_cube(sbo);
    wae = W - a * e2 * GeoStar_cube(cbo);
