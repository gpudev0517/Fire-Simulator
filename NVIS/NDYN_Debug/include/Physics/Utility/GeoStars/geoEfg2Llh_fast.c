...
void     geoEfg2Llh_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    ...
    *lat = atan((efg[GEO_G] + bee2 * GeoStar_cube(su) ) /
    ( p - ae2 * GeoStar_cube(cu) ) );
    slat = sin(*lat);
...
void     geoEfg2Llh_hm_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
...
void     geoEfg2Llh_torge_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double tmp,n,p,slat;
...
*/
void     geoEfg2Llh_bowring_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
...
*/
void     geoEfg2Llh_aa_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
    double phi,p,n;
    double slat;
...
*/
void     geoEfg2Llh_borkowski_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
...
*/
void     geoEfg2Llh_vermeille_fast (int datum,  double efg[],
double *lat, double *lon, double *hgt)
{
