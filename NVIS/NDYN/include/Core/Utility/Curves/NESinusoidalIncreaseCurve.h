...
class NESinusoidalIncreaseCurve :public NECurve
{
public:
	NESinusoidalIncreaseCurve(void);
	~NESinusoidalIncreaseCurve(void);

	NE::NECurveType type() { return NE::kSinusoidal; }
	QString name() { return QString("NESinusoidalIncreaseCurve"); }
