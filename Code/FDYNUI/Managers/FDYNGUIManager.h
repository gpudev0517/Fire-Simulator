        ...
        public ICallInterfaceFromBaseToGUI
{
    ...
    NE_PROP_RW(FDYNTimelineUnits, TimelineUnits, "Timeline Units", "Set Timeline Units", false,)
...
signals:
    ...
    void sendLoadUIData( bool loaduidata );
    void sendSaveUIData( bool saveuidata );
