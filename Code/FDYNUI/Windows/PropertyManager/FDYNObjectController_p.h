...
class FDYNObjectControllerPrivate : public IObjectControllerPrivate
{
    FDYNObjectController* q_ptr;
    Q_DECLARE_PUBLIC(FDYNObjectController)
public:
    FDYNObjectControllerPrivate();
