...
class FZoneInspectorItem;
class NENode;
class EditDelegate;
class QRegExpValidator;


class FZoneInspector : public QTreeWidget
{
    Q_OBJECT
public:
    FZoneInspector(QWidget* parent);
    ~FZoneInspector();
...
private:
    ...
    void traverseTree(const QObject* obj, FZoneInspectorItem* parent);

    FZoneInspectorItem* SceneItem;
    QMap<QString, FZoneInspectorItem*> SceneInpectorItems;

    FZoneInspectorItem* createOrganizerItem(QString name, FZoneInspectorItem *parentItem);
