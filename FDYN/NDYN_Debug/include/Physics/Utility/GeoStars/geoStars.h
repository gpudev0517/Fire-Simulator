...
#include "Utility/globals_Coupling.h"
...
#define GeoStar_cube(n)         (n*n*n)//)pow(n,3.0)       //!< Cubed value: \f$n^3\f$
...
#endif
/* geoEllips function */
 extern NEFEXP_COUPLING void     geoGetEllipsoid(double *a,double *b,double *e2,double *ee2,double *f,int datum);
 extern NEFEXP_COUPLING int      geoInitDatum(GEO_DATUM* d, int datum);
 extern NEFEXP_COUPLING int      geoInitLocation(GEO_LOCATION *l, double lat, double lon, double hgt, int datum,  char *name);
 extern NEFEXP_COUPLING int      geoInitLocation2(GEO_LOCATION *l, double lat, double lon, double hgt, const GEO_DATUM* datum,  const char *name);
 extern NEFEXP_COUPLING void     geoSetTimeZone(GEO_LOCATION *l, double tz, int dst);

/* geoAstro functions */
 extern NEFEXP_COUPLING int      geoSunAzElNow(GEO_LOCATION *loc, double *az, double *el);
 extern NEFEXP_COUPLING int      geoSunAzEltm(GEO_LOCATION *loc, double *az, double *el, struct tm *newtime);
 extern NEFEXP_COUPLING int      geoSunAzElJD(GEO_LOCATION *loc, double *az, double *el, double tjd_now);
 extern NEFEXP_COUPLING int      geoGetSunError(void);
 extern NEFEXP_COUPLING int      geoGettm(int part);
 extern NEFEXP_COUPLING double   geoSunNowEl(double lat, double lon, double hgt);
 extern NEFEXP_COUPLING double   geoSunNowAz(double lat, double lon, double hgt);

/* geoPoint functions */
 double   geoVersion(void);

 extern NEFEXP_COUPLING int      geoEfg2XyzDiff (GEO_LOCATION *src_desc, GEO_LOCATION *tgt_desc,  double xyz_disp[]);
 extern NEFEXP_COUPLING int      geoEfg2XyzDiff_packed(GEO_LOCATION *src_desc, int count, double efg_xyz[]);
 extern NEFEXP_COUPLING void     geoRae2Efg     (GEO_LOCATION *loc, double aer_in[], double efg_out[]);
...
/* geoMag functions */
 ...
 int    geoMag( double alt,  double glat,  double glon,  double time,
              double *dec, double *dip,  double *ti,   double *gv,
