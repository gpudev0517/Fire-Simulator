...
FFactory::FFactory(NEManager* m) : NEMultiNodeFactory(m)
{
    ...
    m_factories.append(new FFireDetectFactory(m) );
    ...
    m_factories.append(new FCFASTPlaneFactory(m));
    m_factories.append(new FOSDCFASTFactory(m) );
    ...
    m_factories.append(new FFireDetectRendererFactory( &NERENDERMAN ) );
    m_factories.append(new FCablesRendererFactory( &NERENDERMAN ) );
    m_factories.append(new FCFASTRendererFactory( &NERENDERMAN ) );
    m_factories.append(new FCFASTPlaneRendererFactory( &NERENDERMAN ) );
    m_factories.append(new FOSDCFASTRendererFactory( &NERENDERMAN) );
