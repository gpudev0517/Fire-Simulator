...
signals:
    ...
    void sendSaveUIOption( bool );
    void sendLoadUIOption( bool );
...
public slots:
    ...
    void updateLoadUIOption(bool loadUI);
    void updateSaveUIOption(bool saveUI);

    QString loadUIData();
    void saveUIData( QString jsonStr );
