...
NE_FWD_DECL_6(class, FDYNGUIManager, NEManager, FDYNTimeline, NEGLWidget, NENode, FDYNMainWindow)
NE_FWD_DECL_6(class, NERenderDialog, NECamera, FDYNDockWidget, NEGLMainWindow, FDYNPropertyEditorWindow, FDYNExternalRendererSettingsWindow)
NE_FWD_DECL_1(struct, GLDockWidgetBundle)
NE_FWD_DECL_1(class, NESpatialEngine);
...
struct GLDockWidgetBundle
{
    ...
    ~GLDockWidgetBundle();
    int id;
    FDYNDockWidget* dockWidget;
    FDYNGLMainWindow* mainWindow;
    NEGLWidget* glWidget;
};

class FDYNGUIManagerPrivate
{
public:
    FDYNGUIManagerPrivate(FDYNGUIManager* s);
    ...
    void toJson(QObject *parent, QJsonArray &guiitems);

    void fromJson( QObject* node, QJsonArray& jsonArray );
    void setPropertyFromJson(QObject* node, QJsonObject &jsonObject );
    QJsonArray getJSONFromProperties(const QObject *obj);
    ...
    void makeGLConnection(NEGLWidget *wid);
    ...
    FDYNTimeline* timeline() { return m_pTimeline; }
#endif
    ...
    void closePropertyEditor(FDYNPropertyEditorWindow* w);
    ...
    FDYNMainWindow* m_pMainWindow;

    FDYNTimeline* m_pTimeline;
#if 0
    FDYNRenderDialog* m_pRenderDialog;
//    NEPreferencesDialog* m_pPreferencesDialog = 0;
#endif

    FDYNExternalRendererSettingsWindow* m_pExtRenderWindow;
    ...
    QList<FDYNPropertyEditorWindow*> m_PropEdWins;
    ...
    FDYNGUIManager::FDYNTimelineUnits m_TimelineUnits;
    ...
    NESpatialEngine *m_spatialEngine;
    NENode *m_cfastEngine;
