...
//        }
        ...
        contentItem: TextInput {
            ...
            text: {
                if (expFormat === 'f')
                    Number(doubleSliderValue).toLocaleString(spinbox.locale, 'f', pSlider.decimals)
                else
                    Number(doubleSliderValue).toLocaleString(spinbox.locale, 'E', pSlider.decimals)
            }
            ...
            onEditingFinished:{
                ...
                sigDoubleSliderValueChanged(Number.fromLocaleString(spinbox.locale, txtValue))
