...
public:
    ...
    FDYNSceneInspectorItem *createRootOrganizerItems( QObject *rootscn, FDYNSceneInspectorItem* rootItem );
...
private:
    ...
    void createCategoryTypes(QObject *rootscn, QStringList &ctypes);
