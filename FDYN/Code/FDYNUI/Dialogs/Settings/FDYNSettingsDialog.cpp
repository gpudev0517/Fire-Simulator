...
void FDYNSettingsDialog::setLoadUIData(bool val)
{
    if( val == true )
        ui->loadUIData->setCheckState( Qt::Checked );
    else
        ui->loadUIData->setCheckState( Qt::Unchecked );
}

void FDYNSettingsDialog::setSaveUIData(bool val)
{
    if( val == true )
        ui->saveUIData->setCheckState( Qt::Checked );
    else
        ui->saveUIData->setCheckState( Qt::Unchecked );
}
