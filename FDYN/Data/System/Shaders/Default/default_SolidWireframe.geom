...
void main()
{
	...
	gHeights = vec3(1, Q2, Q3); 
	oModelPos = gs_in[0].modelPos;
	vProjPos = gl_Position.xyz/gl_Position.w;
	vStartPos = vStartPos;
	EmitVertex();
	
	gl_Position = gl_in[2].gl_Position; 
	gHeights = vec3(Q1, 1, Q3); 
	oModelPos = gs_in[2].modelPos; 
	vProjPos = gl_Position.xyz/gl_Position.w;
	vStartPos = vStartPos;
	EmitVertex();
	
	gl_Position = gl_in[4].gl_Position; 
	gHeights = vec3(Q1, Q2, 1); 
	oModelPos = gs_in[4].modelPos; 
	vProjPos = gl_Position.xyz/gl_Position.w;
	vStartPos = vStartPos;
	EmitVertex();
	EndPrimitive();
